{{-- Navigation Link Partial --}}
{{-- 
Parameters:
- $href: string - the link URL
- $title: string - the link text
- $active: bool (optional, defaults to false) - whether the link is active
- $showActiveIndicator: bool (optional, defaults to true) - whether to show the red border
...
<li class="relative flex items-center">
    @if($showIndicator)
        ...
        <div class="w-[1px] self-stretch mr-0.5 rounded {{ $isActive ? 'bg-red-500' : 'bg-transparent' }}"></div>
    @endif
